...
\includegraphics[width=.5\linewidth]{fig/tri_locations.png}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=.25\linewidth]{fig/elbo_trace_k10.png}%
\includegraphics[width=.25\linewidth]{fig/elbo_trace_wrap2.png}%
\includegraphics[width=.25\linewidth]{fig/elbo_trace_geo.png}%
\includegraphics[width=.25\linewidth]{fig/elbo_trace_tri.png}

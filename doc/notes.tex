...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=\linewidth]{fig/trace_connect_method}
\includegraphics[width=.5\linewidth]{fig/visu_geodesics}%
\includegraphics[width=.5\linewidth]{fig/visu_mst}
\includegraphics[width=.5\linewidth]{fig/splits_connect_method}%
\includegraphics[width=.5\linewidth]{fig/trace_embed_method}
\end{center}
\end{figure}

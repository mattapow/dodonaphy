...
def main():
    ...
    vi.run_tips(dim, S, dna, dists, path_write, epochs=10000, k_samples=3, n_draws=200, **prior)

    # Run Dodoanphy MCMC
    mcmc.run(dim, dna, dists, path_write, epochs=10000, step_scale=0.01, save_period=50, **prior)
